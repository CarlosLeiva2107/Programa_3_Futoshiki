...
class Juego:
    ...
    def top_10_funcion(self):
        ...
        eje_y = 30
        Label(ventana_top_10, text="NIVEL FACIL:        JUGADOR        TIEMPO", font=("Arial", "14")).place(x= 0, y= eje_y)
        #Se suma 25 al eje y
        eje_y += 25
        ...
        for i in lista_facil:
            ...
            Label(ventana_top_10, text=" " * espacios + str(i[0]) + " " * espacios_tiempo + str(i[1]),font=("Arial", "14")).place(x= 0, y= eje_y)
            eje_y += 25

        Label(ventana_top_10, text="NIVEL INTERMEDIO:        JUGADOR        TIEMPO", font=("Arial", "14")).place(x= 0, y= eje_y)
        eje_y += 25
        ...
        Label(ventana_top_10, text="NIVEL DIFICIL:        JUGADOR        TIEMPO", font=("Arial", "14")).place(x= 0, y= eje_y)
        eje_y += 25
